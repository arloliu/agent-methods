...
| Finding judgment | `supported`, `unsupported`, `outdated`, or `unresolved` follows evidence that could confirm or contradict the claim | Reviewer authority substitutes for evidence; failed reproduction treated as rejection; moved defect called outdated |
