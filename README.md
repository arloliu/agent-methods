...
| [release-readiness](#release-readiness) | You need to assess, prepare, or publish a release bound to one candidate commit | `release-readiness/v0.1.1` |
...
| release-readiness | `release-readiness/v0.1.1` | v0.1.0, v0.1.1 |
